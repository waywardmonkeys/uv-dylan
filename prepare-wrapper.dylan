...
define inline C-function %uv-prepare-init
...
define inline C-function %uv-prepare-start
  parameter prepare :: <%uv-prepare>;
...
define inline C-function %uv-prepare-stop
  parameter prepare :: <%uv-prepare>;
  result xxx :: <C-int>;
  c-name: "uv_prepare_stop";
end;

define inline function uv-prepare-start
...
define inline function uv-prepare-stop (prepare :: <uv-prepare>) => (_)
  %uv-prepare-stop(prepare.raw-handle)
end;

define inline C-function %uv-dylan-prepare-new
